package id.ac.poliban.mi.una.recyclerviewespresso_061;
...
import id.ac.poliban.mi.unaa.recyclerviewespresso_061.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("RecyclerView EspressoTest_007");
